<div wire:key="{{ $todo->id }}"
    ...
    <div class="flex justify-between space-x-2">
        ...
        <div class="flex items-center space-x-2">
            ...
            <button wire:click="delete({{ $todo->id }})" wire:confirm="Are you sure want to delete this?"
    ...
    <div class="mt-3 text-xs text-gray-700">
        @if ($editingtodoID === $todo->id)
            <button wire:click="update" wire:confirm="Are you sure want to update this?" class="mt-3 px-4 py-2 bg-teal-500 text-white font-semibold rounded hover:bg-teal-600">Update</button>
